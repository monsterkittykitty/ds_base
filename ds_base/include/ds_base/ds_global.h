...
#define DS_DECLARE_PRIVATE(Class) \
    inline Class##Private* d_func() { return reinterpret_cast<Class##Private *>(d_ptr_.get()); } \
    inline const Class##Private* d_func() const { return reinterpret_cast<const Class##Private *>(d_ptr_.get()); } \
...
#define DS_DECLARE_PUBLIC(Class)                                    \
    inline Class* q_func() { return static_cast<Class *>(q_ptr_); } \
    inline const Class* q_func() const { return static_cast<const Class *>(q_ptr_); } \
    friend class Class;
